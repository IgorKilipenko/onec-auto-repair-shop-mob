...
Функция создатьЗаписьКлиентаНаСервере()
    ...
    СинхронизацияДанных.СоздатьНовуюЗаписьКлиента(Новый ФиксированнаяСтруктура(
    ...
    документЗаписи.Записать(РежимЗаписиДокумента.Проведение, РежимПроведенияДокумента.Неоперативный);
